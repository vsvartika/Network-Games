...
function[xval,poa] = IsolatedOptimizingPoA(n,w, kappa, platform)
    ...
    %-------------LP Matrices details--------------------------------------
    %  
    %     total (n - kappa + 4) variables 
    %        1              variable for f(0)
    %        n - kappa      variables -- for f(1),...,f(n-kappa)
    %        1              variable  -- for f(n+1)
    %        1              variable  -- for mu
    %        1              variable  -- for lambda
    %
    %     5 extra constraint                                 first 5 constraints
    %        4 to accomodate that f(0) = f(n-kappa+1) = 0 
   ...
   %-------------The constraints for Linear Program------------------------
    for j = 1:numRowsIR
        ...
        A(j+5,a+x+1)  =  a;                                  %coefficient of f(a+x)
        A(j+5,a+x+2)  = -b;                                  %coefficient of f(a+x+1)
